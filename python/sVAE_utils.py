...
def corrupt(raw):
    ...
    x, y = shuffle(out,to_categorical(sub_params[:,-2]-1))
...
def build_vae_s(latent_dim, input_type='feat'):
    ...
    plot_model(encoder1, to_file='vae_enc1.png', show_shapes=True)
    ...
    # decoder.summary()
    plot_model(decoder, to_file='vae_dec.png', show_shapes=True)
